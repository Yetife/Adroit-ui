...
export default RegularLoanInterestTable;
...
export function TableData({data, no}) {
    ...
    const [deleteLoan] = useDeleteRegularLoanInterestMutation()
    ...
    return (
        <tr>
            ...
            <AddRegularLoanInterestModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} depositFrom={depositFrom} setDepositFrom={setDepositFrom}
                                             depositTo={depositTo} setDepositTo={setDepositTo} rate={rate} setRate={setRate} purpose={purpose} id={id} selectedValue={selectedValue} setSelectedValue={setSelectedValue}/>
        </tr>
    )
}