...
import AddLoanTenorModal from "./AddLoanTenorModal.jsx";
import {
...
const LoanTenorTable = ({searchTerm}) => {
    ...
    const {data, isFetching, error} =   useGetAllValidLoanTenorsQuery({size, page})
...
const header = ['S/N', 'Tenor', 'Status', 'Actions' ]
