...
const AddFixedDepositTenorModal = ({open, setOpen, checked, setChecked, tenorName, setTenorName,tenorCode, setTenorCode, tenorDesc, setTenorDesc, tenorDays, setTenorDays, purpose, handleAdd}) => {
    const handleChange = (event) => {
        setChecked(event.target.checked);
    };
    const handleNameChange = (e) => {
        setTenorName(e.target.value)
    };
    const handleCodeChange = (e) => {
        setTenorCode(e.target.value)
    };
    const handleDescChange = (e) => {
        setTenorDesc(e.target.value)
    };
...
export default AddFixedDepositTenorModal;