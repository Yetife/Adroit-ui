...
const AddRegularLoanInterestRateModal = ({open, setOpen, checked, setChecked, rate, setRate, depositFrom, setDepositFrom, depositTo, setDepositTo, purpose, selectedValue, setSelectedValue, id}) => {
