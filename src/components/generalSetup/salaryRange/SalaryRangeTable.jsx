...
import {useDeleteSalaryRangeMutation, useEditSalaryRangeMutation,
    useGetAllSalaryRangeQuery
} from "../../../store/features/generalSetup/api.js";
import {updateSnackbar} from "../../../store/snackbar/reducer.js";
import {LinearProgress, ThemeProvider} from "@mui/material";
import themes from "../../reusables/theme.jsx";
import AddSalaryRangeModal from "./AddSalaryRangeModal.jsx";

const SalaryRangeTable = ({searchTerm}) => {
    const {data, isFetching, error} = useGetAllSalaryRangeQuery()
...
const header = ['S/N', 'Salary Range', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    const [deleteSalaryRange] = useDeleteSalaryRangeMutation()
    const [editSalaryRange] = useEditSalaryRangeMutation()
    ...
    return (
        <tr>
            ...
            <AddSalaryRangeModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} range={range} setRange={setRange} handleAdd={handleEdit} purpose={purpose}/>
