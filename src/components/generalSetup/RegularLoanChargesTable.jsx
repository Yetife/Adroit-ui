...
export default RegularLoanChargesTable;
...
const header = ['S/N', 'Charge Amount', 'Is Percentage', 'Loan Amount From', 'Loan Amount To', 'Status', 'Actions' ]
