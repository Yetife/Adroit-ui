...
import {
    useDeleteBankMutation, useEditBankMutation,
...
const header = ['S/N', 'Bank Name', 'Bank Code', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    return (
        <tr>
            ...
            <td className="px-10 py-4 whitespace-no-wrap border-b border-gray-200">
                <span className="text-[16px] leading-5 text-[#4A5D58] font-medium">{data?.bankCode}</span>
            </td>
            <td className="px-10 py-4 whitespace-no-wrap border-b border-gray-200">
