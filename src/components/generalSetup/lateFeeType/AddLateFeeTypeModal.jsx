...
const AddLateFeeTypeModal = ({open, setOpen, checked, setChecked, feeType, setFeeType, purpose, handleAdd}) => {
        ...
        <div>
            ...
            >
                <Dialog.Portal>
                    ...
                    <Dialog.Content className="data-[state=open]:animate-contentShow z-[200] fixed top-[35%] left-[50%] max-h-[55vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[45px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                            ...
                            <div>
                                <span className="ml-8">
                                  ...
                                  <input
                                      ...
                                      placeholder="Enter late fee type name"
...
export default AddLateFeeTypeModal;