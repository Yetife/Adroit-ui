...
import {
    useDeleteLateFeeTypesMutation, useEditLateFeeTypesMutation, useGetAllLateFeeTypesQuery,
} from "../../../store/features/generalSetup/api.js";
import {updateSnackbar} from "../../../store/snackbar/reducer.js";
import {LinearProgress, ThemeProvider} from "@mui/material";
import themes from "../../reusables/theme.jsx";
import AddLateFeeTypeModal from "./AddLateFeeTypeModal.jsx";
import {getPermission} from "../../reusables/getPermission.js";

const LateFeeTypeTable = ({searchTerm}) => {
    const {data, isFetching, error} = useGetAllLateFeeTypesQuery()
...
export default LateFeeTypeTable;
...
const header = ['S/N', 'Late Fee Type Name', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    const [deleteBank] = useDeleteLateFeeTypesMutation()
    const [editBank] = useEditLateFeeTypesMutation()
    ...
    return (
        <tr>
            ...
            <AddLateFeeTypeModal open={open} setOpen={setOpen} handleAdd={handleEdit} feeType={feeType} setFeeType={setFeeType} checked={checked} purpose={purpose} setChecked={setChecked}/>
        </tr>
    )
}