...
import {
    useDeleteDependentsMutation, useEditDependentMutation,
...
const header = ['S/N', 'No. of Dependents(s)', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    const [deleteDependents] = useDeleteDependentsMutation()
    const [editDependents] = useEditDependentMutation()
    ...
    return (
        <tr>
            ...
            <AddDependentsModal open={open} setOpen={setOpen} purpose={purpose} checked={checked} setChecked={setChecked} dependents={dependents} setDependents={setDependents} handleAdd={handleEdit}/>
        </tr>
    )
}