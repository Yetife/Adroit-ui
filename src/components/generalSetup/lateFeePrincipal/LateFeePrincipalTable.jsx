...
import {
    useDeleteLateFeePrincipalMutation, useEditLateFeePrincipalMutation, useGetAllLateFeePrincipalsQuery,
} from "../../../store/features/generalSetup/api.js";
import {updateSnackbar} from "../../../store/snackbar/reducer.js";
import {LinearProgress, ThemeProvider} from "@mui/material";
import themes from "../../reusables/theme.jsx";
import AddLateFeePrincipalModal from "./AddLateFeePrincipalModal.jsx";
import {getPermission} from "../../reusables/getPermission.js";

const LateFeePrincipalTable = ({searchTerm}) => {
...
export default LateFeePrincipalTable;
...
const header = ['S/N', 'Late Fee Principal Name', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    const [deleteBank] = useDeleteLateFeePrincipalMutation()
    const [editBank] = useEditLateFeePrincipalMutation()
    ...
    return (
        <tr>
            ...
            <AddLateFeePrincipalModal open={open} setOpen={setOpen} handleAdd={handleEdit} feePrincipal={feePrincipal} setFeePrincipal={setFeePrincipal} checked={checked} setChecked={setChecked} purpose={purpose}/>
        </tr>
    )
}