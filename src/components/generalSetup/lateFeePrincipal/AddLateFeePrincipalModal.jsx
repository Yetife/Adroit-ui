...
const AddLateFeePrincipalModal = ({open, setOpen, checked, setChecked, feePrincipal, setFeePrincipal, purpose, handleAdd}) => {
    const handleChange = (event) => {
        setChecked(event.target.checked);
    };
    const handlePrincipalChange = (e) => {
        setFeePrincipal(e.target.value)
    };
...
export default AddLateFeePrincipalModal;