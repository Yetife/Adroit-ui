...
import {
    useDeleteTitleMutation, useEditTitleMutation, useGetAllTitleQuery
} from "../../../store/features/generalSetup/api.js";
import {updateSnackbar} from "../../../store/snackbar/reducer.js";
import {LinearProgress, ThemeProvider} from "@mui/material";
import themes from "../../reusables/theme.jsx";
import AddTitleModal from "./AddTitleModal.jsx";
...
const header = ['S/N', 'Title', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    return (
        <tr>
            ...
            <AddTitleModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} title={title} setTitle={setTitle} handleAdd={handleEdit} purpose={purpose}/>
        </tr>
    )
}