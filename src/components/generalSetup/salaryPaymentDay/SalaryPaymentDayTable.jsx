...
import {
    useDeleteSalaryPaymentDayMutation, useEditSalaryPaymentDayMutation,
    useGetAllSalaryPaymentDayQuery,
} from "../../../store/features/generalSetup/api.js";
import {updateSnackbar} from "../../../store/snackbar/reducer.js";
import {LinearProgress, ThemeProvider} from "@mui/material";
import themes from "../../reusables/theme.jsx";
import AddSalaryPaymentDayModal from "./AddSalaryPaymentDayModal.jsx";

const SalaryPaymentDayTable = ({searchTerm}) => {
    const {data, isFetching, error} = useGetAllSalaryPaymentDayQuery()
...
export default SalaryPaymentDayTable;
...
const header = ['S/N', 'Salary Payment Day', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    const [deleteSalaryDay] = useDeleteSalaryPaymentDayMutation()
    const [editSalaryDay] = useEditSalaryPaymentDayMutation()
    ...
    return (
        <tr>
            ...
            <AddSalaryPaymentDayModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} purpose={purpose} paymentDay={paymentDay} setPaymentDay={setPaymentDay} handleAdd={handleEdit}/>
        </tr>
    )
}