...
const AddFixedDepositPreliquidationChargesModal = ({open, setOpen, checked, setChecked, depositFrom, setDepositFrom, depositTo, setDepositTo, percentage, setPercentage, charges, setCharges, purpose, handleAdd}) => {
        ...
        <div>
            ...
            >
                <Dialog.Portal>
                    ...
                    <Dialog.Content className="data-[state=open]:animate-contentShow z-[200] fixed top-[37%] left-[50%] max-h-[67vh] w-[90vw] max-w-[720px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[45px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                                    ...
                                    <div className="px-6">
                                        ...
                                        <span className="ml-8">
                                          ...
                                          <input
                                              ...
                                              placeholder="Enter amount charge"
                                              className="font-medium w-full text-black leading-relaxed px-4 py-2 rounded  border border-neutral-300 justify-between items-center gap-4 flex"
                                          />
                                        </span>
                                    </div>
...
export default AddFixedDepositPreliquidationChargesModal;