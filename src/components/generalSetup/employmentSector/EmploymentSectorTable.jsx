...
import AddEmploymentSectorModal from "./AddEmploymentSectorModal.jsx";
import {updateSnackbar} from "../../../store/snackbar/reducer.js";
import {
    useDeleteEmploymentSectorMutation,
    useEditEmploymentSectorMutation, useGetAllEmploymentSectorsQuery
...
export default EmploymentSectorTable;
...
const header = ['S/N', 'Employment Sector', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    const [delEmploymentSector] = useDeleteEmploymentSectorMutation()
    ...
    const handleRemove = (id)=>{
        delEmploymentSector(id).then((res) => {
            dispatch(
                updateSnackbar({
    ...
    return (
        <tr>
            ...
            <AddEmploymentSectorModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} sector={sector} setSector={setSector} handleAdd={handleEdit} purpose={purpose}/>
        </tr>
    )
}