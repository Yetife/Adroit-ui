...
const AddFeeFrequencyModal = ({open, setOpen, checked, setChecked, feeFreq, setFeeFreq, purpose, handleAdd}) => {
    const handleChange = (event) => {
        setChecked(event.target.checked);
    };
    const handleFreqChange = (e) => {
        setFeeFreq(e.target.value)
    };
...
export default AddFeeFrequencyModal;