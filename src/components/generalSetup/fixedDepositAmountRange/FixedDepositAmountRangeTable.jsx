...
import AddFixedDepositAmountRangeModal from "./AddFixedDepositAmountRangeModal.jsx";

const FixedDepositAmountRangeTable = ({searchTerm}) => {
...
export default FixedDepositAmountRangeTable;
