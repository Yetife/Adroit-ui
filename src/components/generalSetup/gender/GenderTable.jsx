...
import {
    ...
    useEditGenderMutation, useGetAllGendersQuery
} from "../../../store/features/generalSetup/api.js";
import AddGenderModal from "./AddGenderModal.jsx";
...
const header = ['S/N', 'Gender', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    return (
        <tr>
            ...
            <AddGenderModal open={open} setOpen={setOpen} gender={gender} setGender={setGender} checked={checked} setChecked={setChecked} handleAdd={handleEdit} purpose={purpose}/>
