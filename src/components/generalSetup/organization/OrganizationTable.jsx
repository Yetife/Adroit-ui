...
import {
    useDeleteOrganizationMutation, useEditOrganizationMutation, useGetAllOrganizationQuery,
...
export function TableData({data, no}) {
    ...
    return (
        <tr>
            ...
            <td className="px-20 py-4 whitespace-no-wrap border-b border-gray-200">
                <span className="text-[16px] leading-5 text-[#4A5D58] font-medium truncate">{data?.name}</span>
            </td>
            <td className="px-20 py-4 whitespace-no-wrap border-b border-gray-200">
                <span
            ...
            <AddOrganizationModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} organization={organization} setOrganization={setOrganization} purpose={purpose} handleAdd={handleEdit}/>
        </tr>
    )
}