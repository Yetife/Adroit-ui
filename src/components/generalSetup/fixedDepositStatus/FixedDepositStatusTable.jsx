import {
    useDeleteFixedDepositStatusMutation, useEditFixedDepositStatusMutation,
...
export default FixedDepositStatusTable;
...
const header = ['S/N', 'Fixed Deposit Status', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    return (
        <tr>
            ...
            <AddFixedDepositStatusModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} depositStatus={depositStatus} setDepositStatus={setDepositStatus} handleAdd={handleEdit} purpose={purpose}/>
