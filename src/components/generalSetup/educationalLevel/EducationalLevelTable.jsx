...
import {
    useDeleteEducationalLevelMutation, useEditEducationalLevelMutation,
...
import AddEducationLevelModal from "./AddEducationLevelModal.jsx";
const EducationalLevelTable = ({ searchTerm }) => {
    const {data, isFetching, error} = useGetAllEducationalLevelQuery()
...
export default EducationalLevelTable;
...
const header = ['S/N', 'Educational Level', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    const [delEducationalLevel] = useDeleteEducationalLevelMutation()
    ...
    const handleRemove = (id)=>{
        delEducationalLevel(id).then((res) => {
            dispatch(
                updateSnackbar({
