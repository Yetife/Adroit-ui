...
import {useDeleteResidencyMutation, useEditResidencyMutation, useGetAllResidencyQuery
...
const header = ['S/N', 'No. of Years at resident', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    return (
        <tr>
            ...
            <AddResidentModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} resident={resident} setResident={setResident} purpose={purpose} handleAdd={handleEdit}/>
        </tr>
    )
}