...
import {
    useDeleteCountryMutation, useEditCountryMutation, useGetAllCountryQuery, useGetAllTitleQuery,
} from "../../../store/features/generalSetup/api.js";
import {updateSnackbar} from "../../../store/snackbar/reducer.js";
import AddCountryModal from "./AddCountryModal.jsx";
...
const header = ['S/N', 'Country', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    return (
        <tr>
            ...
            <AddCountryModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} country={country} purpose={purpose} setCountry={setCountry} handleAdd={handleEdit}/>
        </tr>
    )
}