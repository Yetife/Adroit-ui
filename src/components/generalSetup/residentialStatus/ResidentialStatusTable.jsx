...
import {useDeleteResidentialStatusMutation, useEditResidentialStatusMutation,
...
export default ResidentialStatusTable;
...
export function TableData({data, no}) {
    ...
    const [deleteResidential] = useDeleteResidentialStatusMutation()
    const [editResidential] = useEditResidentialStatusMutation()
    ...
    return (
        <tr>
            ...
            <AddResidentialStatusModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} residential={residential} setResidential={setResidential} purpose={purpose} handleAdd={handleEdit}/>
        </tr>
    )
}