...
const FilterLoanModal = ({open, setOpen, inputs, setInputs, purpose, handleAdd}) => {
                            ...
                            <div>
                                <div className="flex items-center">
                                    <div className='py-2 flex items-center'>
                                        ...
                                        {/*<DatePicker*/}
                                        {/*    className='border broder-gray-700 ml-3 px-1 rounded-md py-3 text-[14px] focus:outline-none'*/}
                                        {/*    // closeOnScroll={true}*/}
