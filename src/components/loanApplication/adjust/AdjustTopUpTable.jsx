...
import {useGetAllAdjustTopUpQuery} from "../../../store/features/loanApplication/api.js";
import {LinearProgress, ThemeProvider} from "@mui/material";
import themes from "../../reusables/theme.jsx";
import Pagination from "../../reusables/Pagination.jsx";

const AdjustTopUpTable = ({searchTerm, applicationId, name, phone, email, channel, startDate, endDate}) => {
    const [page, setPage] = useState(1)
    const [size, setSize] = useState(10)
    const {data, isFetching, error} =  useGetAllAdjustTopUpQuery({
        size,
        page,
...
export default AdjustTopUpTable;
        ...
        <tr>
            ...
            <td className="px-6 py-4 pt-2 text-xs font-medium leading-5 whitespace-no-wrap border-b border-gray-200">
                 <span
                     ...
                     onClick={() => router(`/loanApp/loanTopUp/edit?id=${data.loanApplicationId}&status=adjust&type=topup`)}>View
                 </span>
            </td>
        </tr>
    )
