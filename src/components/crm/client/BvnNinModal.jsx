        ...
        <div>
            ...
            >
                <Dialog.Portal>
                    ...
                    <Dialog.Content className="data-[state=open]:animate-contentShow z-[200] fixed top-[50%] left-[50%] max-h-[95vh] w-[90vw] max-w-[650px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[42px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                        ...
                        <div className="mt-3">
                            ...
                            <div className="rounded-[5px] my-2 p-4" style={{border: "1px solid #C9D4D1", background: "#FFF"}}>
                                <div className="flex space-x-8">
                                    <div className="pb-4">
                                        ...
                                        <p className="text-[14px] leading-5 text-[#4A5D58] font-[500] pt-1">{data.firstName} {data.lastName}</p>
                                    </div>
                                    <div className="pb-4">
                            ...
                            <div className="rounded-[5px] my-2 p-4 h-[199px]" style={{border: "1px solid #C9D4D1", background: "#FFF"}}>
                                <div className="flex justify-between">
                                    <p className="text-[16px] leading-5 text-[#4A5D58] font-[600]">BVN</p>
                                    <p className="text-[16px] leading-5 text-[#4A5D58] font-[600]">Channel:<span className="font-[500]">Youverify / Verifyme</span></p>
                                </div>
                            </div>
                            <div className="rounded-[5px] my-2 p-4 h-[199px]" style={{border: "1px solid #C9D4D1", background: "#FFF"}}>
                                <div className="flex justify-between">
