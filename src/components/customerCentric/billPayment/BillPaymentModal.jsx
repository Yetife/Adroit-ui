...
import {useModifyBillsPaymentMutation} from "../../../store/features/customerCentric/api.js";
import {updateSnackbar} from "../../../store/snackbar/reducer.js";
import {useDispatch} from "react-redux";
const BillPaymentModal = ({open, setOpen, id}) => {
    const dispatch = useDispatch()
    const [modifyBills] = useModifyBillsPaymentMutation()
