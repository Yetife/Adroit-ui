...
const FilterEscrowModal = ({open, setOpen, handleFilter}) => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(`${baseUrl}/CustomerCentric/GetAllEscrowStatus`, {
                headers: {
...
export default FilterEscrowModal;