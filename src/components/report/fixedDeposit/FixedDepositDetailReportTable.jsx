...
const FixedDepositDetailReportTable = ({data, page, handlePageChange, handleRowPerPageChange}) => {
    return (
...
const header = ['S/N', 'Email Address', 'First Name', 'Last Name', 'Fixed Amount', 'Fixed Date', 'Total Withdraw', 'Current Balance', 'Status']
