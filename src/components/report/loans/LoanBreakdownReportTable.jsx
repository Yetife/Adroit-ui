...
const LoanBreakdownReportTable = ({data, page, handlePageChange, handleRowPerPageChange}) => {
    return (
...
export default LoanBreakdownReportTable;
...
const header = ['S/N', 'First Name', 'Middle Name', 'Last Name', 'Email Address', 'DOB', 'BVN', 'Loan Amount', 'Loan Tenor', 'Disbursed Amount', 'Total Management Fee', 'Loan Type', 'Disbursed To', 'Wallet ID/Bank Account', 'Start Date', 'End Date']
...
export function TableData({data, no}) {
    return (
        <tr>
            ...
            <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                <span className="text-[16px] leading-5 text-[#4A5D58] font-medium truncate">{data?.disbursedTo}</span>
            </td><td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                <span className="text-[16px] leading-5 text-[#4A5D58] font-medium truncate">{data?.walletAccount}</span>
            </td>
            <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                <span
