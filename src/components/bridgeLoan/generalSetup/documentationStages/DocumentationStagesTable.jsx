...
import {
    useDeleteDocumentationStageMutation, useEditDocumentationStageMutation, useGetAllValidDocumentationStageQuery,
} from "../../../../store/features/bridgeLoan/api.js";
import {updateSnackbar} from "../../../../store/snackbar/reducer.js";
import {LinearProgress, ThemeProvider} from "@mui/material";
import themes from "../../../reusables/theme.jsx";
import AddDocumentStagesModal from "./AddDocumentStagesModal.jsx";

const DocumentationStagesTable = ({searchTerm}) => {
    const {data, isFetching, error} = useGetAllValidDocumentationStageQuery()
...
export default DocumentationStagesTable;
...
const header = ['S/N', 'Document Stages', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    const [deleteStage] = useDeleteDocumentationStageMutation()
    const [editStage] = useEditDocumentationStageMutation()
    ...
    return (
        <tr>
            ...
            <AddDocumentStagesModal open={open} setOpen={setOpen} stages={stages} setStages={setStages} checked={checked} setChecked={setChecked} handleAdd={handleEdit} purpose={purpose}/>
        </tr>
    )
}