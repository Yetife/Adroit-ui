...
const header = ['S/N', 'Interest Rate', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    return (
        <tr>
            ...
            <AddInterestRateModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} rate={interest} setRate={setInterest} handleAdd={handleEdit} purpose={purpose}/>
        </tr>
    )
}