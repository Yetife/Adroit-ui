...
import {
    ...
    useEditFacilityTypeMutation, useGetAllValidFacilityTypeQuery,
} from "../../../../store/features/bridgeLoan/api.js";
import {updateSnackbar} from "../../../../store/snackbar/reducer.js";
import {LinearProgress, ThemeProvider} from "@mui/material";
import themes from "../../../reusables/theme.jsx";
import AddFacilityTypeModal from "./AddFacilityTypeModal.jsx";

const FacilityTypeTable = ({searchTerm}) => {
    const {data, isFetching, error} = useGetAllValidFacilityTypeQuery()
...
const header = ['S/N', 'Facility Type', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    const [deleteType] = useDeleteFacilityTypeMutation()
    const [editType] = useEditFacilityTypeMutation()
    ...
    return (
        <tr>
            ...
            <AddFacilityTypeModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} type={type} setType={setType} handleAdd={handleEdit} purpose={purpose}/>
        </tr>
    )
}