...
import {
    useDeleteDisbursementStatusMutation, useEditDisbursementStatusMutation,
...
export default DisbursementStatusTable;
...
const header = ['S/N', 'Disbursement Status', 'Status', 'Actions' ]
