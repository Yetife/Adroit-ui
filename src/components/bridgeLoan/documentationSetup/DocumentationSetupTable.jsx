...
import AddDocumentationSetupModal from "./AddDocumentationSetupModal.jsx";
...
const DocumentationSetupTable = ({searchTerm}) => {
    const {data, isFetching, error} = useGetAllValidDocumentSetupQuery()
...
export default DocumentationSetupTable;
...
const header = ['S/N', 'Documentation Name', 'Status', 'Actions' ]
...
export function TableData({data, no}) {
    ...
    return (
        <tr>
            ...
            <AddDocumentationSetupModal open={open} setOpen={setOpen} checked={checked} setChecked={setChecked} docName={docName} setDocName={setDocName}  handleAdd={handleEdit} purpose={purpose}/>
        </tr>
    )
}