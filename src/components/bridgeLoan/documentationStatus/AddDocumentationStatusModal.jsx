...
const AddDocumentationStatusModal = ({open, setOpen, purpose, checked, setChecked, docStatus, dateCreated, setDocStatus, handleAdd}) => {
...
export default AddDocumentationStatusModal;