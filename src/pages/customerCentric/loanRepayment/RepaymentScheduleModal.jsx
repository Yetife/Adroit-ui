...
import {CircularProgress, Divider, ThemeProvider} from "@mui/material";
...
const RepaymentScheduleModal = ({open, setOpen, id, loanId, name}) => {
    ...
    const {data, isFetching, error} =  useGetLoanRepaymentPlanQuery({id, loanId})
                        ...
                        <div>
                            {
                                isFetching ? <ThemeProvider theme={themes}>
                                    ...
                                    </ThemeProvider> : <div className="mt-6">
                                        <div className="flex cursor-pointer">
                                            <p className={`${tabItem === "schedule" ? "border-b-8 border-b-[#00C795] pb-2 font-[700]" : ""} text-[16] font-[500] px-20`}
                                               onClick={() => handleTab("schedule")}>Repayment Schedule</p>
                                            <p className={`${tabItem === "debit" ? "border-b-8 border-b-[#00C795] pb-2 font-[700]" : ""} text-[16] font-[500] px-20`}
                                               onClick={() => handleTab("debit")}>Manual Debit</p>
                                        </div>
                                        <Divider/>
                                        {tabItem === "schedule" && <div>
                                            <p className="text-[16px] pt-3 leading-5 text-[#3A3A3A] font-[700] pb-1">Customer
                                            ...
                                            <div
                                                ...
                                                <table className="scroll-container table-auto">
                                                    <thead>
                                                    <tr>
                                                        <th className="py-1 pr-8 text-[14px] font-medium leading-4 text-[#007970]  border-b">
                                                            Repayment Date
                                                        </th>
                                                        <th className="py-1 pr-8 text-[14px] font-medium leading-4 text-[#007970] border-b">
                                                            Amount
                                                        </th>
                                                        <th className="py-1 px-4 text-[14px] font-medium leading-4 text-[#007970] border-b truncate">
                                                            Total Late Fee
                                                        </th>
                                                        <th className="py-1 px-4 text-[14px] font-medium leading-4 text-[#007970] border-b truncate">No.
                                                            Of Days
                                                        </th>
                                                        <th className="py-1 px-4 text-[14px] font-medium leading-4 text-[#007970] border-b truncate">
                                                            Close Late Fee
                                                    ...
                                                    <span
                                                        className="text-[14px] leading-5 text-[#4A5D58] font-medium">&#8358;{formatRepayment(item?.repaymentAmount)}</span>
                                                                ...
                                                                <td className="py-1 px-4 whitespace-no-wrap border-b border-gray-200">
                                                    <span
                                                    ...
                                                    <span
                                                        className="text-[14px] leading-5 text-[#4A5D58] font-medium">{item?.lateFeeNumberOfDays === 0 ? "" : item?.lateFeeNumberOfDays}</span>
                                                                ...
                                                                <td
                                                                    className="py-1 px-4 whitespace-no-wrap border-b border-gray-200">
                                                                    {item.isLateFeeCleared && <span
                                                                        className="text-[14px] leading-5 text-[#4A5D58] font-medium">Closed</span>}
                                                                    {!item.isLateFeeCleared && <span
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="py-1 px-8 whitespace-no-wrap border-b border-gray-200">
                                                            <p className="text-[16px] pt-3 leading-5 text-[#4A5D58] font-[700]">
                                                                &#8358;{totalRepaymentAmount.toLocaleString("en-US", {})}</p>
                                                        </td>
                                                        <td className="py-1 px-8 whitespace-no-wrap border-b border-gray-200">
                                                            <p className="text-[16px] pt-3 leading-5 text-[#4A5D58] font-[700]">
                                                                &#8358;{totalLateFee.toLocaleString("en-US", {})}</p>
                                                        </td>
                                                        <td className="py-1 px-8 whitespace-no-wrap border-b border-gray-200">
                                        ...
                                        <span>
                                          ...
                                          />
                                                ...
                                                <div className="flex justify-center mt-6">
                                                    ...
                                                    <Button className="ml-2" variant="primary" bgColor="#00C795"
                                                            borderRadius="4px"
                                                            height="45px" size='md' as={ReactLink} w={'160px'}
                                                            onClick={handleRepay}>
