...
import DeclinedRestructureTable from "../../components/loanApplication/declined/DeclinedRestructureTable.jsx";
import DeclinedTopUpTable from "../../components/loanApplication/declined/DeclinedTopUpTable.jsx";
    ...
    return (
        <Layout>
            <div className="px-2">
                ...
                <div>
                    {selectedOption === "regularLoan" && <DeclinedTable searchTerm={searchTerm} applicationId={filters.applicationId} name={filters.name}
                                    phone={filters.phone}
                                    startDate={filters.startDate} endDate={filters.endDate} email={filters.email}
                                    channel={filters.channel}/>}
                    {selectedOption === "loanRestructure" && <DeclinedRestructureTable searchTerm={searchTerm} applicationId={filters.applicationId} name={filters.name}
                                    phone={filters.phone}
                                    startDate={filters.startDate} endDate={filters.endDate} email={filters.email}
                                    channel={filters.channel}/>}
                    {selectedOption === "loanTopUp" && <DeclinedTopUpTable searchTerm={searchTerm} applicationId={filters.applicationId} name={filters.name}
                                    phone={filters.phone}
                                    startDate={filters.startDate} endDate={filters.endDate} email={filters.email}
                                    channel={filters.channel}/>}
                </div>
