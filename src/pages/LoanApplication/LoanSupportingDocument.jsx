...
const LoanSupportingDocument = () => {
    ...
    return (
        <div className="flex">
            ...
            <div onClick={openExplorer} style={{border: '1px solid rgba(105, 119, 115, 0.50', background: '#F3F3F3'}} className="flex flex-col items-center cursor-pointer py-12 w-[271px] h-[171px] ml-12">
                <input
                    ref={fileInputRef}
                    type="file"
                    id="fileInput"
                        ...
                        {selectedFiles.map((file, index) => (
                            <div key={index} className="flex items-center">
                                ...
                                <button
                                    ...
                                    className="ml-2 mt-3 text-red-500 font-medium"
                                >
                                    <Close style={{font: '10px'}}/>
                                </button>
                            </div>
                        ))}
                        <button
                            onClick={uploadFiles}
                            className="bg-[#00C796] rounded py-2 px-6 flex text-white mt-4"
                        >
                            Upload
                        </button>
                    </div>
