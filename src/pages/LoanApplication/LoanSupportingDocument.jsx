    ...
    return (
        <div className="flex">
            <div onClick={openExplorer} style={{border: '1px solid rgba(105, 119, 115, 0.50', background: '#F3F3F3'}} className="flex flex-col items-center cursor-pointer py-12 w-[271px] h-[171px]">
                ...
                <p className="font-medium text-[#4A5D58] text-[14px] whitespace-nowrap pt-4">Upload Document</p>
            </div>
            ...
            <div style={{border: '1px solid rgba(105, 119, 115, 0.50', background: '#F3F3F3'}} className="flex flex-col items-center py-12 w-[271px] h-[171px] ml-12">
                ...
                <p className="font-medium text-[#4A5D58] text-[14px] whitespace-nowrap pt-4">Upload Guarantor’s Form</p>
            </div>
        </div>
    );
};
