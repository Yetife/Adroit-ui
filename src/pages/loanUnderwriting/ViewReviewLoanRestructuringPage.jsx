...
const ViewReviewLoanRestructuringPage = () => {
                                    ...
                                    }
                                    {
                                        status === "disburse" && (
                                            <div className="float-right my-4">
                                                {permissions.canDisburse && <Button variant="primary" bgColor="#00C795" borderRadius="4px"
                                                         height="37px" size='md'
...
export default ViewReviewLoanRestructuringPage;